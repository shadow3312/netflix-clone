...
export default function Navbar() {
    ...
    return (
        <div className={`nav fixed top-0 mb-32 w-full h-20 ${show && 'bg-netflix-black'} flex pl-12 p-4 justify-between items-center transition-all duration-500 ease-in`} style={{zIndex: 999}}>
            <Image
